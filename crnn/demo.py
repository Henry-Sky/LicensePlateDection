...
parser.add_argument('-o', '--output_path', type = str, required = True, help = 'result output path')
...
with open(os.path.join(args.output_path, "results.txt"), 'w', encoding="utf-8") as f:
    f.write(sim_pred)
    print("Saving result to %s" % args.output_path)