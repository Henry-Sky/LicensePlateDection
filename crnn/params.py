...
# training process
batch_displayInterval = 16 # interval to be print the train loss
batch_valInterval = 1000 # interval to val the model loss and accuray
batch_n_val_disp = 10 # number of samples to display when val the model

epoch_displayInterval = 5
